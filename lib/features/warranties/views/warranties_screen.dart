...
class _WarrantiesScreenState extends State<WarrantiesScreen> {
  ...
  Widget _buildWarrantyCard(BuildContext context, WarrantyModel item) {
    ...
    final Color badgeBg = item.isExpiring
        ? const Color(0xFFFFF3E0)
        : (item.isActive ? const Color(0xFFE8F5E9) : const Color(0xFFFFEBEE));
    final Color badgeTextColor = item.isExpiring
        ? const Color(0xFFE65100)
        : (item.isActive ? const Color(0xFF2E7D32) : const Color(0xFFC62828));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Top Header: Cert Name & Status Pill
          Row(
          ...
          if (item.vehicleTitle.isNotEmpty || item.vehicleRegistration.isNotEmpty) ...[
            Text(
